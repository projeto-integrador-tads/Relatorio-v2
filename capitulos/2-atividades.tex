...
%Estrutura geral do projeto (pasta, componentes, padrões adotados). Frameworks e bibliotecas utilizadas (React, Vue, Angular, etc.). Comunicação com o back-end (REST API, GraphQL, WebSockets).

\subsection{Design e UX (Experiência do Usuário)}

%Princípios de design adotados. Uso de Design Systems ou bibliotecas (Material UI, Tailwind, Bootstrap). Acessibilidade e usabilidade.
